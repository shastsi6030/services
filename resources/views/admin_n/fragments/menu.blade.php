        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('app/cmsadmin/admin/sliders')}}"><i class="fa fa-circle-o"></i>مشاهده همه</a></li>
                    <li><a href="{{url('app/cmsadmin/admin/sliders/create')}}"><i class="fa fa-circle-o"></i> ایجاد جدید</a></li>
